...
if __name__ == "__main__":
    ...
    plt.figure()
    plt.hist(times, Nmeas+1, density=True, facecolor='r', alpha=0.5, label="assuming $\\mathbb{H}_0$")
    if haveInput:
        plt.hist(times_avg, Nmeas+1, density=True, facecolor='y', alpha=0.7, label="assuming $\\mathbb{H}_1$")
        plt.legend()
